...
//                    tvValue0.setText(dataSet.getLabel() + "：" + df.format(y * 100) + "%");
                    tvValue0.setText(dataSet.getLabel() + "：" + ((int)(y * 1000)) + "");
                }
                if (i == 1) {
//                    tvValue1.setText(dataSet.getLabel() + "：" + df.format(y * 100) + "%");
                    tvValue1.setVisibility(View.VISIBLE);
                    tvValue1.setText(dataSet.getLabel() + "：" + ((int)Math.ceil(y * 1000)) + "");
                }
                if (i == 2) {
//                    tvValue1.setText(dataSet.getLabel() + "：" + df.format(y * 100) + "%");
                    tvValue2.setVisibility(View.VISIBLE);
                    tvValue2.setText(dataSet.getLabel() + "：" + ((int)Math.ceil(y * 1000)) + "");
                }
            }
