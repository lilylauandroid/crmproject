...
public class PermissionUtils {
    /**跳转应用详情设置权限*/
    public static final int APP_SETTINGS_RC = 10076;
    /**请求闪屏页的必要权限*/
    ...
    /**请求读取通讯录权限*/
    public static final int REQUEST_READ_CONTACTS = 10063;
    /**请求读取存储卡权限*/
...
//                intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
        ...
        builder.setNegativeButton("取消", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                dialog.dismiss();
                if (requestCode == REQUEST_SPLASH_PERMISSIONS){
                    ((MyApplication)activity.getApplication()).ActivitiesDestroy();
                }
            }
        });
        builder.create().show();
    ...
    public static String getPermissionExplain(String permission){
        ...
        if (DangerousPermissions.READ_CONTACTS.equals(permission)){
            permissionExplain =  "读取通讯录的权限";
        }
